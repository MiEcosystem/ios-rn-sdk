...
class ProjectorBoxVC extends React.Component {
  constructor(props, context) {
    ...
    console.log('--------ProjectorBoxVC-this.props-------------'+JSON.stringify(this.state));
  }
          ...
          <View style={styles.scrollContentView}>
                <View style={styles.TopMenuView}>
                      <View style={styles.middleButtonView}>
                          ...
                          <View style={styles.threeButtonView}>
                                <Button   onPress={()=>{this.onPressButton('MENU')}} enabled={this.isButtonEnabled('MENU')} shock ={true}  imageNormal="NewControllerImage/tv_menu_normal.png" imageHighlight='NewControllerImage/tv_menu_press.png' imageWidth={60} imageHeight={60} />
                          </View> 
                          <View style={styles.threeButtonView}>
                                <Button   onPress={()=>{this.onPressButton('BACK')}} enabled={this.isButtonEnabled('BACK')} shock ={true} imageNormal="NewControllerImage/tv_back_normal.png" imageHighlight='NewControllerImage/tv_back_press.png' imageWidth={60} imageHeight={60} />
                          </View>   
                      </View>
                </View>
                {this.showMenuView()}
        ...
        <View style={styles.BottomMenuView}>
            <View style={styles.directionView}>
                  <View style={styles.directionContentView}>
                          <DirectionView 
                          style={[styles.directionContentView,{'width':210,'height':210}]} 
            ...
            <View style={styles.BottomView}>
                ...
                <View style={styles.BottomMiddleView}>
                      ...
                      <Button style={styles.bottomMoreButton} onPress={()=>{this.onPressExtendButton('EXPANSION')}} enabled={this.isEnableExtendButton()} shock ={true} imageNormal="NewControllerImage/tv_extend_normal_special.png" imageHighlight='NewControllerImage/tv_extend_press_special.png' imageWidth={60} imageHeight={60} />
                </View>
  ...
  deal_ExtendViewData(allKeys){
      ...
      var bindKeyArray =['POWER','MENU','BACK','VOL+','VOL-','CH+','CH-',
...
const directionViewHeight = (screenHeight-NavigatorBarHeight-SafeBottomHeight)-(sectionHeght)- (BottomViewHeight);
...
var styles = StyleSheet.create({
  ...
  BottomMenuView:{
    height:screenHeight- NavigatorBarHeight-sectionHeght,
    width:screenWidth,
  },
  extendButtonView:{
...
const KEY_OF_MAINPAGE = 'ProjectorBoxVC';
