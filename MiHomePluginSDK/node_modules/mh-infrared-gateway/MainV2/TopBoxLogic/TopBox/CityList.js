...
class CityList extends Component {
    ...
    getBrandDataSource() {
        ...
        MIRequestServer.Post_GetAllCityList(param,
            function(response) {
                console.log('Post_GetAllCityList:' + JSON.stringify(response));
                if (response.result.cities != undefined) {
                    var dataArray = response.result.cities;
                    sourceData = dataArray;
                    self.setState({ cities: dataArray });
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <MHTableView style={styles.table} tableName="CityList" ref={component => this._tableView = component} onSelectRow={this._onSelectRow.bind(this)} />
            </View>
        )
    }
    ...
    _onSelectRow(event) {
        console.log('_onSelectRow------------' + JSON.stringify(event));
        /* 跳转到对码页面*/
        ...
        if (this.props.selectedRow != undefined) {
            console.log('_onSelectRow--obj-----------------' + obj);
        ...
        this.props.navigator.push({
            ...
            passProps: {
                ...
                selectedRow: function(event) {
                    console.log('searchOnFocus------------' + JSON.stringify(event));
...
const KEY_OF_MAINPAGE = 'CityList';
var route = {
    key: KEY_OF_MAINPAGE,
    title: '城市列表',
    component: CityList,
