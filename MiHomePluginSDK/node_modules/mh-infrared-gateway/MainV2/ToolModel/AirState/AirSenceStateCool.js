...
var currentAirMode;
class AirSenceStateCool extends  React.Component {
  ...
  instanceWithModel(Model){
    // console.log('----cool--------instanceWithModel--------------'+JSON.stringify(Model));
  ...
  pressTemperatureAdd(temp){
    console.log('pressTemperatureAdd--cool------------'+temp);
...
module.exports.AirSenceStateCool = AirSenceStateCool;
