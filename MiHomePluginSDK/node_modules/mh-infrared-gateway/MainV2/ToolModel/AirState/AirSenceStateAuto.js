...
class AirSenceStateAuto extends  React.Component {
  ...
  pressTemperatureAdd(temp){
      ...
      console.log('pressTemperatureAdd--auto------------'+temp);
  ...
  pressWindSpeed(speed){
    ...
    console.log('333333------------------pressWindSpeed');
...
module.exports.AirSenceStateAuto = AirSenceStateAuto;
