...
class AirSenceStateHot extends  React.Component {
  ...
  instanceWithModel(Model){
    // console.log('----hot--------instanceWithModel--------------'+JSON.stringify(Model));
  ...
  pressTemperatureAdd(temp){
      console.log('pressTemperatureAdd--temp------------'+temp);
...
module.exports.AirSenceStateHot = AirSenceStateHot;
