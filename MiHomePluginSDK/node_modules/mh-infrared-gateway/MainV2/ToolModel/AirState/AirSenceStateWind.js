...
class AirSenceStateWind extends  React.Component {
  ...
  instanceWithModel(Model){
      // console.log('----Wind--------instanceWithModel--------------'+JSON.stringify(Model));
  ...
  pressTemperatureAdd(temp){

    console.log('pressTemperatureAdd--wind------------'+temp);
      var TemperatureNumberArray = this.OriginalData.temps;
      var new_temperature = temp ;
  ...
  getCurrentUIState(){
    ...
    // console.log('new_currentUIState----------'+JSON.stringify(new_currentUIState));
...
module.exports.AirSenceStateWind = AirSenceStateWind;
