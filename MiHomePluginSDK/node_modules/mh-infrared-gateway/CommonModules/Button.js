...
class Button extends Component {
    constructor(props) {
        super(props);
        var titleMarginTop = this.props.titleMarginTop?(this.props.titleMarginTop):(13);
        this.state = {
    ...
    componentDidMount() {
        ...
        if(this.props.textMarginTop>0){
          this.setState({titleMarginTop:this.props.titleMarginTop });
        }
    }
    ...
    componentWillReceiveProps(props){
      if(props.studyEnable==true){
        this.setState({imagebackgroundColor:'#00ae58'});
      }
    }
        ...
        if (this.props.title!=null) {
            ...
            return (
              <View {...viewProps}>
                ...
                <Text style={[styles.text,{marginTop:this.state.titleMarginTop},{color:this.state.textColor},{fontSize: this.state.titleSize, opacity: opacityValue}]}>{this.props.title}</Text>
              </View>
            );
        } else {
            return (
                <TouchableHighlight {...touchableProps} underlayColor={this.props.highlightColor ? this.props.highlightColor : "transparent"} style={[{opacity: opacityValue,alignSelf: 'center'}]}>
                  <Image style={[styles.image, {width: this.state.imageWidth, height: this.state.imageHeight,backgroundColor:this.state.imagebackgroundColor}]}
                         source={{isStatic:!MHPluginSDK.devMode, uri:MHPluginSDK.basePath + this.state.imageName}}>
