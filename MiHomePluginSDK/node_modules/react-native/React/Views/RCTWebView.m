...
// [martes] patch scroll
@interface RCTWebView () <UIScrollViewDelegate>

@property (nonatomic, copy) RCTDirectEventBlock onScrollChange;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
  if (_onScrollChange)
  {
    ...
    event[@"x"] = @(scrollView.contentOffset.x);
    event[@"y"] = @(scrollView.contentOffset.y);
