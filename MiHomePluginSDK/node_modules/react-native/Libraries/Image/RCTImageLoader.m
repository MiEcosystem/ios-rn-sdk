                                          ...
                                          completionBlock:(void (^)(NSError *error, id imageOrData))completionBlock
{
  ...
  dispatch_async(_URLCacheQueue, ^{
    ...
    //[khzliu] fix ImageLoader caching problem on iOS
    ...
    //[khlziu] Fixed a crash where making a network request with unrecognized/unsupported scheme would crash by attempting to insert a nil RCTNetworkTask into an array.
    if(task){
